...
export function getIntersectPointBetweenCircleAndLine2(x1, y1, x2, y2, m, n, r) {
...
export function getIntersectPointBetweenCircleAndLine3(alpha, beta, m, n, r) {
    const a = 1 + alpha * alpha;
    const b = -2 * (m - alpha * beta + alpha * n);
    const c = m * m + beta * beta - 2 * beta * n + n * n - r * r;
    const s = b * b - 4 * a * c;
...
export function getIntersectPointBetweenCircleAndSegment(x1, y1, x2, y2, m, n, r) {
